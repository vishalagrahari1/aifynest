      ...
      {phase === 'landing' && (
        <div>
          ...
          <div style={{ backgroundColor: 'var(--bg-card)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-xl)', padding: '32px 24px', marginBottom: '40px' }}>
            ...
            <p style={{ fontSize: 'var(--text-xs)', color: 'var(--text-secondary)', textAlign: 'center', marginBottom: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
              ...
              <div style={{ border: '1px solid var(--border-color)', borderRadius: 'var(--radius-lg)', padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backgroundColor: 'var(--bg-primary)' }}>
                <div>
                  <span style={{ fontSize: '10px', fontWeight: 'bold', color: 'var(--text-muted)', textTransform: 'uppercase' }}>FREE DIRECTORY</span>
                  <h3 style={{ fontSize: 'var(--text-base)', fontWeight: 'bold', margin: '4px 0 8px 0' }}>Standard Listing</h3>
                  <div style={{ fontSize: 'var(--text-2xl)', fontWeight: 'bold', marginBottom: '12px' }}>$0</div>
                  <ul style={{ fontSize: '11px', color: 'var(--text-secondary)', paddingLeft: '16px', margin: '0 0 16px 0', lineHeight: '1.6' }}>
                    <li>Catalog index & search</li>
                    <li>Community user reviews</li>
                    <li>Standard verification queue</li>
                  </ul>
                </div>
                <button onClick={() => setPhase('wizard')} className="btn btn-outline w-full" style={{ fontSize: '12px' }}>
                  Submit Standard Free
                </button>
              </div>
              ...
              {/* Option 3: Featured Pack ($69) */}
              <div style={{ border: '1px solid var(--border-color)', borderRadius: 'var(--radius-lg)', padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', backgroundColor: 'var(--bg-primary)' }}>
                <div>
                  <span style={{ fontSize: '10px', fontWeight: 'bold', color: 'var(--color-gold)', textTransform: 'uppercase' }}>MAXIMUM VISIBILITY</span>
