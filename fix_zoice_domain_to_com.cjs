...
async function fixZoiceDomainToCom() {
  console.log('🚀 Authenticating Admin Session to update Zoice URLs to zoice.com...');
  ...
  const zoiceUpdate = {
    website_url: 'https://zoice.com',
    pricing_url: 'https://zoice.com/pricing',
    affiliate_url: 'https://zoice.com',
    logo_url: 'https://www.google.com/s2/favicons?domain=zoice.com&sz=128'
  };
  ...
  if (dbErr) {
    ...
    console.log('✅ Updated Zoice tool in Supabase DB to https://zoice.com and official logo!');
  }
  ...
  if (zoiceTool) {
    zoiceTool.websiteUrl = 'https://zoice.com';
    zoiceTool.pricingUrl = 'https://zoice.com/pricing';
    zoiceTool.affiliateUrl = 'https://zoice.com';
    zoiceTool.logoUrl = 'https://www.google.com/s2/favicons?domain=zoice.com&sz=128';
    ...
    console.log('✅ Updated Zoice in seedData.ts to https://zoice.com!');
  }
}
